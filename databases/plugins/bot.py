...
import git
import heroku3
# changed root to databases
from databases import BOT0, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9
from databases import OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY, adityaversion
from databases import CMD_HNDLR as hl
from telethon.tl.functions.users import GetFullUserRequest
# alive Pic By Default It's Will Show Our
from databases import ALIVE_PIC
from telethon import events, version, Button
from telethon.tl.custom import button
from time import time
from datetime import datetime

KAAL_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/9c426032f68839db25c0d.jpg"
  

ADITYA = "✯ KAAL SPAM BOT ✯\n\n"
ADITYA += f"═══════════════════\n"
ADITYA += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.10.1`\n"
ADITYA += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
ADITYA += f"• **ᴅᴇᴀᴅʟʏʙᴏᴛ ᴠᴇʀsɪᴏɴ**  : `{adityaversion}`\n"
ADITYA += f"═══════════════════\n\n"   
